...
functions and emits string-literal accesses, named direct calls, and tiny local
contexts so missing-field guard semantics can be determined without exporting
large decompiler output.
"""
...
def main() -> int:
    ...
    report = {"schema": 1, "functions": functions}
